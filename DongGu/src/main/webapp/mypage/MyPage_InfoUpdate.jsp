	      	...
	      	<form action="/DongGu/mypage/MyPage_InfoUpdate_ok.jsp" method="post" enctype="multipart/form-data">
                <ul id="jyl_joinul">
                    ...
                    <li class="jyl_inputlist">
                        <i>닉네임</i>
                        <% if (m_usertype==1){%>
                        <input type="text" name="p_nickname" placeholder="닉네임을 입력하세요" value="<%= dto.getP_nickname()%>">
                        <% }else if (m_usertype==0){%>
                        <input type="text" name="o_nickname" placeholder="닉네임을 입력하세요" value="<%= dto.getO_nickname()%>">                        
                        <% }%>
                    </li>
                    <li class="jyl_inputlist">
                        <i>전화번호</i>
