...
public class animalDTO {
	...
	public animalDTO(int ai_num, int at_num, String ai_name, int ai_gender, String ai_img, Date ai_birth, String an_num_link,
			String ai_alergy, String ai_disease, String ai_caution, int a_num, String a_name, int an_num,
			String an_word, String at_name) {
		super();
		this.ai_num = ai_num;
		this.at_num = at_num;
	...
	public Date getAi_birth() {
		return ai_birth;
	}


	public void setAi_birth(Date ai_birth) {
		this.ai_birth = ai_birth;
	}
